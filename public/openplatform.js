...
OP.$process = function(data) {
	...
	if (data.type === 'appearance' && OP.$appearance) {
		...
		style.appendChild(document.createTextNode(':root{--opcolor:' + d.colorscheme + '}.opbody{background-color:#' + (d.darkmode ? '202020' : 'FFFFFF') + '}body.opbody{color:#' + (d.darkmode ? 'E0E0E0' : '000000') + '}.opborder,.opborderhover:hover{border-color:' + d.colorscheme + '!important}.opbg,.opbghover:hover{background-color:' + d.colorscheme + '!important}.opfg,.opfghover:hover{color:' + d.colorscheme + '!important}'));
		style.id = 'opstyle';
