...
OPENPLATFORM.clientside = function() {
	return '<script>var OPENPLATFORM={};OPENPLATFORM.version="1.0.0",OPENPLATFORM.callbacks={},OPENPLATFORM.events={},OPENPLATFORM.is=top!==window,OPENPLATFORM.loading=function(n){return OPENPLATFORM.send("loading",n)},OPENPLATFORM.warning=function(n){return OPENPLATFORM.send("warning",n)},OPENPLATFORM.success=function(n){return OPENPLATFORM.send("success",n)},OPENPLATFORM.play=function(n){return OPENPLATFORM.send("play",n)},OPENPLATFORM.stop=function(n){return OPENPLATFORM.send("stop",n)},OPENPLATFORM.maximize=function(n){return OPENPLATFORM.send("maximize",n)},OPENPLATFORM.restart=function(){return OPENPLATFORM.send("restart",location.href)},OPENPLATFORM.open=function(n,e){return OPENPLATFORM.send("open",{id:n,message:e})},OPENPLATFORM.minimize=function(){return OPENPLATFORM.send("minimize")},OPENPLATFORM.close=function(){return OPENPLATFORM.send("kill")},OPENPLATFORM.notify=function(n,e,O){return"string"==typeof n&&(O=e,e=n,n=0),OPENPLATFORM.send("notify",{type:n,body:e,url:O||"",datecreated:new Date})},OPENPLATFORM.getProfile=function(n){return OPENPLATFORM.send("profile",n)},OPENPLATFORM.getApplications=function(n){return OPENPLATFORM.send("applications",n)},OPENPLATFORM.getUsers=function(n){return OPENPLATFORM.send("users",n)},OPENPLATFORM.getInfo=function(n){return OPENPLATFORM.send("info",n)},OPENPLATFORM.onMinimize=function(n){return OPENPLATFORM.on("minimize",n)},OPENPLATFORM.onMaximize=function(n){return OPENPLATFORM.on("maximize",n)},OPENPLATFORM.onClose=function(n){return OPENPLATFORM.on("close",n)},OPENPLATFORM.onMessage=function(n){return OPENPLATFORM.on("message",n)},OPENPLATFORM.send=function(n,e,O){"function"==typeof e&&(O=e,e=null);var P={};if(P.openplatform=!0,P.type=n,P.body=e||null,P.sender=!0,top)return O&&(P.callback=(1e6*Math.random()).toString(32).replace(/\./g,""),OPENPLATFORM.callbacks[P.callback]=O),top.postMessage(JSON.stringify(P),"*"),OPENPLATFORM;O&&O(new Error("The application is not runned in the openplatform scope."))},OPENPLATFORM.on=function(n,e){return OPENPLATFORM.events[n]||(OPENPLATFORM.events[n]=[]),OPENPLATFORM.events[n].push(e),OPENPLATFORM},window.addEventListener("message",function(n){try{var e=JSON.parse(n.data);if(!e.openplatform)return;if(e.callback){var O=OPENPLATFORM.callbacks[e.callback];return void(O&&(e.sender&&(e.error=new Error("The application is not runned in the openplatform scope.")),O(e.error,e.body||{}),delete OPENPLATFORM.callbacks[e.callback]))}if(e.sender)return;"kill"===e.type&&(e.type="close");var P=OPENPLATFORM.events[e.type];P&&P.forEach(function(n){n(e.body||{})})}catch(n){}},!1);</script>';
};
