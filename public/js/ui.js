...
Thelpers.initials = function(value) {
	...
	return '<span class="initials" style="background-color:{1}" title="{2}">{0}</span>'.format(initials, user.colorscheme || '#4285f4', value);
};
...
COMPONENT('form', 'zindex:30;scrollbar:1', function(self, config, cls) {
...
COMPONENT('processes@2', function(self, config) {
	...
	self.resize_maximize = function(id) {
	...
	w.on('resize', function() {
		...
		for (var i = 0; i < iframes.length; i++) {
			...
			setTimeout(self.notifyresize, 100, iframe.id);
		}
	});
...
COMPONENT('largeform', 'zindex:30;padding:30;scrollbar:1;scrolltop:1;style:1', function(self, config, cls) {
...
COMPONENT('statsbarsimple', 'tooltip:1;animate:1;value:value;colors:#3182BD,#FD8D3C,#74C476,#9E9AC8,#969696,#bd6b27,#808080', function(self, config, cls) {
