...
exports.install = function() {
	...
	F.route('/internal/users/place/',              json_schema_save,               ['authorize', 'post', '*UserPlace']);
	F.route('/internal/users/department/',         json_schema_save,               ['authorize', 'post', '*UserDepartment']);
